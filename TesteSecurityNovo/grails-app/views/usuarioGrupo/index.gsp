		...
		<div id="list-usuarioGrupo" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nome" title="${message(code: 'usuarioGrupo.nome.label', default: 'Nome')}" />
				...
				<g:each in="${usuarioGrupoInstanceList}" status="i" var="usuarioGrupoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${usuarioGrupoInstance.id}">${fieldValue(bean: usuarioGrupoInstance, field: "nome")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate total="${usuarioGrupoInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
