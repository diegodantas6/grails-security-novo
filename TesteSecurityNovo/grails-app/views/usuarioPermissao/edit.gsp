...
<html>
	...
	<body>
		<a href="#edit-usuarioPermissao" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-usuarioPermissao" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:usuarioPermissaoInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${usuarioPermissaoInstance?.version}" />
				<fieldset class="form">
